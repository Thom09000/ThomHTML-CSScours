...
tab1.push(0);
console.log("état ableau 1", tab1.length);
...
tab1.pop();
console.log("état tableau 1", tab1.length);
...
console.log("état du tableau 1+2");
for (let i = 0; i<tab1.length; i++) {
...
//let maVariable = tab1[tab1.length-1];
